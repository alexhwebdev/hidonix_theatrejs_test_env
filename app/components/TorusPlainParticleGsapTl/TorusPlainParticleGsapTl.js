...
export default function TorusPlainParticleGsapTl(
  { 
    scale,
    // position = [3, 0, 0] 
  }
  ...
  const material = useMemo(() => {
    return new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        color1: { value: new THREE.Color('#a68a64') }, 
        color2: { value: new THREE.Color('#665b40') }, 
        color3: { value: new THREE.Color('#958667') }  
      },
